...
public class FutureUtils {
     ...
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:25
     */
     ...
     * @return {@link CompletableFuture }<{@link T }>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:23
     */
     ...
     *
     * @param completableFutures 可完成期货
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:21
     */
     ...
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:19
     */
     ...
     * @return {@link CompletableFuture }<{@link Map }<{@link K }, {@link V }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:38:35
     */
     ...
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:03
     */
     ...
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:06
     */
     ...
     *
     * @param completableFutures 可完成期货
     * @param filterFunction     过滤功能
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:08
     */
    public static <T> CompletableFuture<List<T>> sequence(Collection<CompletableFuture<T>> completableFutures,
     ...
     * @return {@link CompletableFuture }<{@link List }<{@link T }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:11
     */
    public static <T> CompletableFuture<List<T>> sequenceList(Collection<CompletableFuture<List<T>>> completableFutures,
                                                              Predicate<? super T> filterFunction) {
        return CompletableFuture.allOf(completableFutures.toArray(new CompletableFuture<?>[0]))
     ...
     * @return {@link CompletableFuture }<{@link Map }<{@link K }, {@link V }>>
     * @author qingmeng
     * @createTime: 2024/06/13 12:39:13
     */
    public static <K, V> CompletableFuture<Map<K, V>> sequenceMap(
