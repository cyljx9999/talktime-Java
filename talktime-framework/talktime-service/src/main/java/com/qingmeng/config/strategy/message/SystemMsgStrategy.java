...
import com.qingmeng.dto.chat.msg.ImgMsgDTO;
 ...
 */
@Component
public class SystemMsgStrategy extends AbstractMessageStrategy{
    ...
    public void saveExtraMessage(ChatMessage msg, ChatMessageDTO messageDTO) {
        ImgMsgDTO imgMsgDTO = BeanUtil.toBean(messageDTO.getBody(), ImgMsgDTO.class);
