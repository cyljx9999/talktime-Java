...
import com.qingmeng.dto.chat.msg.FileMsgDTO;
 ...
 */
@Component
public class FileMsgStrategy extends AbstractMessageStrategy{
    ...
    public void saveExtraMessage(ChatMessage msg, ChatMessageDTO messageDTO) {
        FileMsgDTO fileMsgDTO = BeanUtil.toBean(messageDTO.getBody(), FileMsgDTO.class);
